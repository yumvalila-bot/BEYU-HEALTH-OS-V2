...
export class AuthController {
  ...
  async restore(@Req() req: Request, @Res({ passthrough: true }) res: Response) {
    const refreshToken = this.readRefreshToken(req);
  ...
  async logout(@Req() req: Request, @Res({ passthrough: true }) res: Response, @Body() logoutDto: LogoutDto) {
